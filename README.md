...
* Ingestion Agent (data_ingest_agent): Triggered daily by Cloud Scheduler. Reads raw data from Google Cloud Storage, runs sentiment classification using a BERT model, and saves scores to BigQuery.
